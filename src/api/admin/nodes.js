      ...
      const enriched = await Promise.all(
        nodes.map(async node => {
          ...
          return {
            ...
            capacity_total_gb: Math.round((node.capacity_total_bytes / (1024 * 1024 * 1024)) * 100) / 100,
            capacity_used_gb: Math.round((node.capacity_used_bytes / (1024 * 1024 * 1024)) * 100) / 100,
            capacity_available_gb: Math.round(((node.capacity_total_bytes - node.capacity_used_bytes) / (1024 * 1024 * 1024)) * 100) / 100,
            status: node.status,
